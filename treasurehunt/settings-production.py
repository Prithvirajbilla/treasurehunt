...
ADMINS = (
     ('prithvirajbilla', 'prithviraj.m.billa@gmail.com'),
)
...
DATABASES = {
    'default': {
        ...
        'NAME': 'treasurehunt',                      # Or path to database file if using sqlite3.
...
ALLOWED_HOSTS = ['treasurehunt.stab-iitb.org' ]
...
STATIC_ROOT = '/var/www/treasurehunt/staticfiles/'
...
SECRET_KEY = "eyerv($()$mhbu1emwz1&$y@vopdch2vfri7+rm(d!cjf2_rh"
